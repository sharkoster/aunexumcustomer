                            ...
                            <div class="col-12">
                                ...
                                <div class="table-responsive mb-3">
                                    <table class="table table-condensed table-metal-gold" style="width: 100%">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><a href="mijn-edelmetalen.php">Gouden Maple Leaf 1 t/oz</a></td>
                                            <td><a href="mijn-edelmetalen.php" class="expand-up">4</a></td>
                                            <td>€ 5571,96</td>
                                            <td>€ 6.430,20</td>
                                        ...
                                        <tr>
                                            <td>- Sealbagnr: #90860530</td>
                                            <td>1</td>
                                            <td>€ 1.392,94</td>
                                            <td>€ 1.607,55</td>
                                            <td class="c-green">€ 1.607,55</td>
                                            <td>n.v.t.</td>
                                            <td>Aunexum Safe: <img src="/img/vlag-nederland.svg"></td>
                                            <td>11/12/2018</td>
                                            <td><button type="button" class="btn btn-outline-warning btn-sm">Verkoop</button></td>
